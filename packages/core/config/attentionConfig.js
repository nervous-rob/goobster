...
const CANDIDATES = {
    ...
    /** BLOCKED/REVIEW missions newer than this are still news. Deadline
     *  candidates are selected by deadline, not updatedAt — an untouched
     *  two-week mission must still surface when its due date enters the
     *  horizon. */
