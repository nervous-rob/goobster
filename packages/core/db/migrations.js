...
const COLUMN_MIGRATIONS = [
    ...
    ['project_mission_steps', 'startedByUserId', 'startedByUserId TEXT'],
    ...
    ['project_mission_approval_receipts', 'kind', "kind TEXT NOT NULL DEFAULT 'approve'"],
