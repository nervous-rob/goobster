...
- Premiums are **simulated and labelled as such everywhere**: Black-Scholes on the real underlying, volatility estimated from three months of real closes, with a volatility smile, a front-week term bump, and a house spread. There is no keyless real option feed, so the game says what it is doing rather than pretending
