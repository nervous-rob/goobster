...
| #272 | #285–286 merged; final batch-1 slice implemented | Back, fixed-signal feedback, Research, Projects basics, Plans, Runs, Inbox and Scheduled shipped. Memory, Settings, Usage and operator-only Host now have safe v2 previews. Later batches and human validation remain pending; #273 is the next research-workflow step. |
