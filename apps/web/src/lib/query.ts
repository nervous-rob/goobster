...
export const keys = {
    ...
    projectFiles: (slug: string, dir = '') => ['project-files', slug, dir] as const,
    projectTriggers: (slug: string) => ['project-triggers', slug] as const,
    projectConversation: (slug: string) => ['project-conversation', slug] as const,
