...
const intentDetectionHandler = require('@goobster/core/utils/intentDetectionHandler');
...
async function handleImageEditReply(message, referencedImage) {
    ...
    const { editImageFromUrl } = require('@goobster/core/utils/imageDetectionHandler');
